### B1: Phiên bản Python 3.7 trở lên
### B2: Mở Terminal tại thư mục chứa đồ án
### B3: Tạo môi trường ảo 
###     python -m venv venv
### B4: Kích hoạt môi trường ảo
###     Window: .\venv\Scripts\activate
###     Mac: source venv/bin/activate
### B5: Cài đặt thư viện: pip install Flask flask-sqlalchemy
